...
def download_pacs(data_dir):
    ...
    download_and_extract(
        "https://drive.google.com/file/d/0B6x7gtvErXgfbF9CSk53UkRxVzg/view?usp=drive_link&resourcekey=0-aQEyqs-mKSsoWHvclYvgjw",
...
if __name__ == "__main__":
    ...
    vars()["download_{}".format(args.dataset)](args.data_dir)